<template>
  ...
  <div class="wrapper">
    ...
    <div class="color-wrapper">
      <el-button
        v-for="color of cubeColors"
        :key="color"
        :color="color"
        size="large"
        circle
        @click="onSelectedColorChange(color)"
      >
  ...
  <el-divider />
  <div class="wrapper">
    <el-button v-if="invalidPosition" type="warning" size="large" disabled plain
      >该位置上已有方块</el-button
    >
    <el-button v-else type="primary" size="large" @click="onAddClick"
      >添加方块</el-button
    >
  </div>
</template>
